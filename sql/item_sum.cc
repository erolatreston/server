...
struct st_repack_tree {
  ...
  size_t len, maxlen;
  /*
    TRUE when NULL values are ignored
  */
  bool skip_nulls;
};
...
bool Item_func_group_concat::add(bool exclude_nulls)
{
  ...
  /*
    Store the length of the values of the arguments in the table. This is needed
    for repacking the ORDER BY tree and honour group_concat_max_len.
  */
  if (tree)
